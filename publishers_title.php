...
<head>
    ...
    <style>
        ...
        .bottom-section {
            ...
            display: flex;
            flex-direction: column;
            /* Updated: Remove justify-content center to allow footer at bottom */
            padding: 20px 30px 15px 30px; /* Adjusted padding */
        }

        /* Wrapper to keep form centered vertically in available space */
        .form-container {
            flex: 1; /* Takes up all space above footer */
            display: flex;
            align-items: center;
            justify-content: center;
            width: 100%;
...
<body>
    ...
    <div class="top-section">
        ...
        <h1 class="page-title">PUBLISHERS &<br>TITLES</h1>
    </div>
    ...
    <div class="bottom-section">
            ...
            <form action="" method="POST">
                <div class="input-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="publisher" name="publisher" placeholder="SEARCH">
                    </div>
                </div>
        ...
        <footer class="footer">
            ...
            <div class="footer-text">By: Group 2</div>
        </footer>
